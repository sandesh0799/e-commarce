                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                ...
                                {product.countInStock > 0 ? (<div className="flex ml-6 items-center">
                            ...
                            <div className="flex">
                                ...
                                {product.countInStock > 0 ?
                                    (<button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={addToCartHandeler}>Add to cart</button>)
                                    : (<button className="flex ml-auto cursor-not-allowed text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" >Unavailable</button>)
